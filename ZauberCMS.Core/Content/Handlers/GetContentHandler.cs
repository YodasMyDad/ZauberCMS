    ...
    : IRequestHandler<GetContentCommand, Models.Content?>
{
    ...
    private static string GenerateCacheKey(GetContentCommand request, IZauberDbContext dbContext)
    {
    ...
    private static IQueryable<Models.Content> BuildQuery(GetContentCommand request, IZauberDbContext dbContext)
    {
    ...
    private static async Task<Models.Content?> FetchContentAsync(GetContentCommand request, IZauberDbContext dbContext, CancellationToken cancellationToken)
    {
        var query = BuildQuery(request, dbContext);
